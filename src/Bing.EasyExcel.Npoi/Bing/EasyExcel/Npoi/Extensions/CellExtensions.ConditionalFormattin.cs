...
namespace Bing.EasyExcel.Npoi.Extensions
{
    ...
    public static partial  class CellExtensions
    {
        ...
        private static bool ExistConditionalFormatting(this NPOI.SS.UserModel.ICell cell,
            NPOI.SS.UserModel.IConditionalFormatting cf) =>
            cf.GetFormattingRanges().Any(cra =>
                cell.RowIndex >= cra.FirstRow &&
                cell.RowIndex <= cra.LastRow &&
                cell.ColumnIndex >= cra.FirstColumn &&
