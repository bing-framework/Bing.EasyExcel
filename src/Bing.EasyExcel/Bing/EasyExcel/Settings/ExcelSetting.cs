namespace Bing.EasyExcel.Settings
{
    ...
    public sealed class ExcelSetting
    {
        ...
        /// 标题
        /// </summary>
        public string Title { get; set; } = "Bing.EasyExcel";

        /// <summary>
        /// 主题
        /// </summary>
        public string Subject { get; set; } = "Bing.EasyExcel";

        /// <summary>
        /// 类别
        /// </summary>
        public string Category { get; set; } = "Bing.EasyExcel";

        /// <summary>
        /// 备注
        /// </summary>
        public string Description { get; set; } = "Bing.EasyExcel 生成";
